...
<html lang="en">
    ...
    <body>
        ...
        echo "<div class='alert alert-danger' role='alert'>Not available at the moment. Please try again later.</div>";
        ...
        echo "   <table class='table table-hover'>";
            ...
            echo "  <tbody>";
                ...
                <tr>
                    ...
                    echo "<td><a href='book.php?&appid=" . $row['scheduleId'] . "&scheduleDate=".$q."' class='btn btn-".$btnclick." btn-xs' role='button' ".$btnstate.">Book Now</a></td>";
                    // echo "<td><a href='book.php?&appid=" . $row['scheduleId'] . "&scheduleDate=".$q."'>Book</a></td>";
