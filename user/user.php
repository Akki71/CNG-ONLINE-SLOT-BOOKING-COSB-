...
{
header("Location: /cng/cng.html");
}

$usersession = $_SESSION['id'];


$res=mysqli_query($con,"SELECT * FROM users WHERE id=".$usersession);
...
<html lang="en">
	...
	<body>
		...
		<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="../cng.html">COSB</a>
				</div>
		...
		<!-- 1st section start -->
		<section id="promo-1" class="content-block promo-1 min-height-600px bg-offwhite" style="background:url('../img/cng.png') ;background-repeat: no-repeat ;background-position: bottom;
    background-size: contain;">
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-md-8">
							...
							<h2>Hi <?php echo $userRow['username']; ?> . Book Your Slot!</h2>
		...
		<div class="copyright-bar bg-black">
			<div class="container">
				<p class="pull-left small">© COSB</p>
				<p class="pull-right small">@2022 <i class="fa fa-heart pomegranate"></i> </p>
			</div>
		</div>
		<!-- footer end -->
