...
echo "<h1>Your Slot List. </h1>";
echo "</div>";
echo "<div class='panel panel-primary'>";
echo "<div class='panel-heading'>List of Booked Slot</div>";
...
echo "<td><a href='invoice.php?appid=".$userRow['id']."' target='_blank'><span class='glyphicon glyphicon-print' aria-hidden='true'></span></a> </td>";
}
