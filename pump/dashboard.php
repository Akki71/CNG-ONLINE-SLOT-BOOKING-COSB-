                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($book=mysqli_fetch_array($res)) {
                                ...
                                echo "<tr class='$status'>";
                                    ...
                                    echo "<td>" . $book['scheduleDay'] . "</td>";
                                    echo "<td>" . $book['scheduleDate'] . "</td>";
                                    echo "<td>" . $book['startTime'] . "</td>";
                                    echo "<td>" . $book['endTime'] . "</td>";
                                    echo "<td><span class='glyphicon glyphicon-".$icon."' aria-hidden='true'></span>".' '."". $book['status'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><input type='checkbox' name='enable' id='enable' value='".$book['id']."' onclick='chkit(".$book['id'].",this.checked);' ".$checked."></td>";
                                    echo "<td class='text-center'><a href='#' id='".$book['id']."' class='delete'><i class='fa-regular fa-circle-xmark'></i></a>
                            </td>";
