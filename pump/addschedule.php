...
//INSERT
$query = " INSERT INTO schedule (  scheduleDate, scheduleDay, startTime, endTime,  bookAvail)
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                       ...
                       <!--  <li>
                            <a href="patientlist.php"><i class="fa fa-fw fa-edit"></i> Slot Book List</a>
                        </li> -->
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <!-- panel heading starat -->
                        <div class="panel-heading">
                            <h3 class="panel-title">List of your slot</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($schedule=mysqli_fetch_array($result)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td>" . $schedule['scheduleDay'] . "</td>";
                                    echo "<td>" . $schedule['startTime'] . "</td>";
                                    echo "<td>" . $schedule['endTime'] . "</td>";
                                    echo "<td>" . $schedule['bookAvail'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$schedule['scheduleId']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                            </td>";
